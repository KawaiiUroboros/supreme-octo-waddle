...
func request_NotyfierService_GetNotification_0(ctx context.Context, marshaler runtime.Marshaler, client NotyfierServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
...
func local_request_NotyfierService_GetNotification_0(ctx context.Context, marshaler runtime.Marshaler, server NotyfierServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq GetNotificationRequest
	var metadata runtime.ServerMetadata
...
// RegisterNotyfierServiceHandlerServer registers the http handlers for service NotyfierService to "mux".
// UnaryRPC     :call NotyfierServiceServer directly.
...
func RegisterNotyfierServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server NotyfierServiceServer) error {
	...
	mux.Handle("GET", pattern_NotyfierService_GetNotification_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		...
		resp, md, err := local_request_NotyfierService_GetNotification_0(rctx, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
		...
		forward_NotyfierService_GetNotification_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
// RegisterNotyfierServiceHandlerFromEndpoint is same as RegisterNotyfierServiceHandler but
// automatically dials to "endpoint" and closes the connection when "ctx" gets done.
func RegisterNotyfierServiceHandlerFromEndpoint(ctx context.Context, mux *runtime.ServeMux, endpoint string, opts []grpc.DialOption) (err error) {
	...
	return RegisterNotyfierServiceHandler(ctx, mux, conn)
}

// RegisterNotyfierServiceHandler registers the http handlers for service NotyfierService to "mux".
// The handlers forward requests to the grpc endpoint over "conn".
func RegisterNotyfierServiceHandler(ctx context.Context, mux *runtime.ServeMux, conn *grpc.ClientConn) error {
	return RegisterNotyfierServiceHandlerClient(ctx, mux, NewNotyfierServiceClient(conn))
}

// RegisterNotyfierServiceHandlerClient registers the http handlers for service NotyfierService
// to "mux". The handlers forward requests to the grpc endpoint over the given implementation of "NotyfierServiceClient".
// Note: the gRPC framework executes interceptors within the gRPC handler. If the passed in "NotyfierServiceClient"
...
func RegisterNotyfierServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client NotyfierServiceClient) error {
	...
	mux.Handle("GET", pattern_NotyfierService_GetNotification_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_NotyfierService_GetNotification_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
...
var (
	...
	pattern_NotyfierService_GetNotification_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 1, 0, 4, 1, 5, 1}, []string{"GetNotification", "userid"}, "", runtime.AssumeColonVerbOpt(true)))
)
...
var (
	...
	forward_NotyfierService_GetNotification_0 = runtime.ForwardResponseMessage
)
